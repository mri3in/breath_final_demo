 ...
 */
    ...
    // ---------------- INSERT INTO NOTIFICATION TABLE --------------------
        ...
        $notification_content = "User <b>".$login_session."</b> recently editted warehouse no. <b>".$edit_warehouse_id."</b>.";
        $action_type = "Edit";
        $module_category = "Inventory";
        $notification_link = "../html/edit_warehouse.html?warehouse_id=".$edit_warehouse_id;

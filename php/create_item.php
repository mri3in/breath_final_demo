 ...
 */
    ...
    if ($found_item == 0) {
        ...
        mysqli_query($db, "INSERT INTO item 
        (item_id, item_category_id, item_name, item_unit_of_measurement, 
        item_expiry_period, item_cost, item_unit_price, item_power, 
        item_power_unit, item_phase, item_voltage_low, item_voltage_high, 
        item_frequency, item_diameter, item_capacity, item_area, 
        item_description, item_VAT, item_vendor, item_manufacturer, 
        item_quantity, item_photo, item_status, item_create_datetime) 
		VALUES 
		('$_POST[item_id]', '$_POST[item_category]', '$_POST[item_name]', '$_POST[item_unit_of_measurement]',
		'$_POST[item_expiry_period]', '$_POST[item_cost]', '$_POST[item_unit_price]', '$_POST[item_power]',
		'$_POST[item_power_unit]', '$_POST[item_phase]', '$_POST[item_voltage_low]', '$_POST[item_voltage_high]',
		'$_POST[item_frequency]', '$_POST[item_diameter])', '$_POST[item_capacity]', '$_POST[item_area]',
		'$_POST[item_description]', '$_POST[item_vat]', '$_POST[item_vendor]', '$_POST[item_manufacturer]',
		'$_POST[item_quantity]', '$file_to_saved' ,'$item_status', '$creationDateTime')");
    } 
    ...
    $notification_content = "User <b>".$login_session."</b> created a new item no. <b>".$item_id."</b>.";
    $action_type = "Create";
    $module_category = "Inventory";
    $notification_link = "../html/edit_item.html?item_id=".$item_id;

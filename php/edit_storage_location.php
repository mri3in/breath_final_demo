...
// ---------------- INSERT INTO NOTIFICATION TABLE --------------------
    ...
    $notification_content = "User <b>".$login_session."</b> recently editted storage location no. <b>".$edit_storage_location_id."</b>.";
    $action_type = "Edit";
    $module_category = "Inventory";
    $notification_link = "../html/edit_storage_location.html?storage_location_id=".$edit_storage_location_id;

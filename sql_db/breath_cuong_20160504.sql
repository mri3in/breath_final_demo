...
--
-- Host: 127.0.0.1
-- Generation Time: May 04, 2016 at 02:27 PM
...
('347929', 1, 'Whisperflo Pumps', 'pcs', NULL, '200000', '5000000', 1.50, 'HP', 3, NULL, 220.00, 50.00, NULL, NULL, NULL, NULL, '5%', 'ABC', 'Sanyo', 0.00, '0.00', 'Active', 'pump.jpg'),
...
CREATE TABLE IF NOT EXISTS `notification` (
  ...
  `notification_status` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `notification` (`notification_id`, `notification_content`, `notification_date`, `notification_status`) VALUES
(1, 'Cuong created order', '2016-04-22', 'Unread'),
(2, 'Item 0111111 is created', '2016-04-23', 'Unread'),
(3, 'Item 900000 is deleted', '2016-04-22', 'Read'),
(4, 'Customer Tran Van Cuong is created', '2016-04-25', 'Read');
